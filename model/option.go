...
func InitOptionMap() {
	...
	common.OptionMap["ModelPricePerSecond"] = ratio_setting.ModelPricePerSecond2JSONString()
	common.OptionMap["ModelTieredPrice"] = ratio_setting.ModelTieredPrice2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ModelPricePerSecond":
		err = ratio_setting.UpdateModelPricePerSecondByJSONString(value)
		if err == nil {
			go RefreshPricing()
		}
	case "ModelTieredPrice":
		err = ratio_setting.UpdateModelTieredPriceByJSONString(value)
		if err == nil {
			go RefreshPricing()
		}
	case "CacheRatio":
